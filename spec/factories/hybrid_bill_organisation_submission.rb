FactoryBot.define do
  factory :hybrid_bill_organisation_submission do
    ...
    factory :hybrid_bill_organisation_submission_with_agent_params do
      has_a_rep 'true'
    ...
    factory :hybrid_bill_organisation_submission_with_an_agent do
      has_a_rep 'true'
