FactoryBot.define do
  factory :hybrid_bill_organisation_group_submission do
    on_behalf_of 'a group of organisations'
    first_name 'susan'
    surname 'conkers'
    ...
    factory :hybrid_bill_organisation_group_submission_with_agent_params do
      has_a_rep 'true'
    ...
    factory :hybrid_bill_organisation_group_submission_with_an_agent do
      has_a_rep 'true'

      hybrid_bill_agent build(:hybrid_bill_agent)
    end
  end
end
