FactoryBot.define do
  factory :hybrid_bill_individual_group_submission do
    ...
    factory :hybrid_bill_individual_group_submission_with_agent_params do
      has_a_rep 'true'
    ...
    factory :hybrid_bill_individual_group_submission_with_an_agent do
      has_a_rep 'true'
